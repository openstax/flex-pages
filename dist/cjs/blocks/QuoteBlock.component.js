...
function QuoteBlock({ data }) {
    ...
    const style = accentColor
        ...
        : undefined;
    return (0, jsx_runtime_1.jsxs)("div", { className: `content-block-quote quote-layout-${layout}`, style: style, children: [(0, jsx_runtime_1.jsx)(Image_js_1.Image, { alt: "", image: data.value.image }), (0, jsx_runtime_1.jsx)(RichTextBlock_component_js_1.RichTextContent, { html: data.value.content }), (0, jsx_runtime_1.jsxs)("div", { className: "quotee", children: [(0, jsx_runtime_1.jsx)("span", { className: "name", children: data.value.name }), data.value.title ? (0, jsx_runtime_1.jsx)("span", { className: "title", children: data.value.title }) : null] })] });
}
