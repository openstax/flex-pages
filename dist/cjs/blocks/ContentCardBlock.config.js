...
exports.config = {
    ...
    categories: ['content'],
    label: 'Content Card',
    description: 'A card linked to another page on the site. Title, image, and excerpt are pulled from the referenced page by default; each can be overridden per card.',
    fields: [
