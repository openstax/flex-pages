...
function SectionBlock({ data, content, activeConditions }) {
    ...
    const backgroundColor = (_e = (0, utils_1.findByType)(data.value.config, 'background_color')) === null || _e === void 0 ? void 0 : _e.value;
    const gradientColor = (_f = (0, utils_1.findByType)(data.value.config, 'gradient_color')) === null || _f === void 0 ? void 0 : _f.value;
    const gradientDirection = (_g = (0, utils_1.findByType)(data.value.config, 'gradient_direction')) === null || _g === void 0 ? void 0 : _g.value;
    ...
    return (0, jsx_runtime_1.jsx)("section", { id: id, className: (0, classnames_1.default)('content-block-section', { 'dark-background': bg.isDark, [`content-block-${flex}`]: flex }), "data-analytics-nav": analytics, style: { background: bg.background, backgroundColor: bg.backgroundColor,
        ...
        }, children: (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('section-content', 'flex-content-container', (0, utils_1.flexAlignClass)(textAlign)), style: { textAlign, display, flexDirection: 'column' }, children: content }) });
}
