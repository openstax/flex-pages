...
function WellBlock({ data }) {
    ...
    const width = (_j = (0, utils_1.findByType)(data.value.config, 'width')) === null || _j === void 0 ? void 0 : _j.value;
    const textAlign = (_k = (0, utils_1.findByType)(data.value.config, 'text_alignment')) === null || _k === void 0 ? void 0 : _k.value;
