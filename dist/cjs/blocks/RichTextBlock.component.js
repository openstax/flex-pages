...
function RichTextContent({ html }) {
    ...
    if (html.includes('data-flex-link')) {
        return (0, jsx_runtime_1.jsx)(RawHtmlWithLinks_js_1.RawHtmlWithLinks, { block: true, className: 'content-block-rich-text', html: html });
    }
    return (0, jsx_runtime_1.jsx)(Html_js_1.Html, { block: true, className: 'content-block-rich-text', html: html });
}
