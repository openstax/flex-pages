...
const CTABlock_fields_js_1 = require("./CTABlock.fields.js");
exports.fields = {
    type: 'cards_block',
    label: 'Cards Block',
    categories: ['content'],
    fields: [
        { name: 'cards', label: 'Cards', type: 'list', fields: [
                ...
                { name: 'ctaBlock', label: 'Call To Action', type: 'list', fields: CTABlock_fields_js_1.ctaLinkFieldConfig, max: 1 },
            ] },
