...
exports.config = {
    ...
    fields: [
        ...
        { name: 'config', label: 'Config', type: 'configs', configs: [
                ...
                { name: 'top_border_size', label: 'Top Border Size', type: 'number',
                    help: 'Top border width in pixels' },
                { name: 'top_border_color', label: 'Top Border Color', type: 'text', pattern: '#[a-fA-F0-9]{6}',
                    help: 'Hex color for the top border' },
                { name: 'bottom_border_size', label: 'Bottom Border Size', type: 'number',
                    help: 'Bottom border width in pixels' },
                { name: 'bottom_border_color', label: 'Bottom Border Color', type: 'text', pattern: '#[a-fA-F0-9]{6}',
                    help: 'Hex color for the bottom border' },
