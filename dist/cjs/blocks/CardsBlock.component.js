...
function CardsBlock({ data }) {
    ...
    const layout = (_b = (0, utils_js_1.findByType)(data.value.config, 'layout')) === null || _b === void 0 ? void 0 : _b.value;
    const cardSize = (_c = (0, utils_js_1.findByType)(data.value.config, 'card_size')) === null || _c === void 0 ? void 0 : _c.value;
    const cardColumns = (_d = (0, utils_js_1.findByType)(data.value.config, 'card_columns')) === null || _d === void 0 ? void 0 : _d.value;
    const cardMinSize = (_e = (0, utils_js_1.findByType)(data.value.config, 'card_min_size')) === null || _e === void 0 ? void 0 : _e.value;
    const backgroundColor = (_f = (0, utils_js_1.findByType)(data.value.config, 'background_color')) === null || _f === void 0 ? void 0 : _f.value;
    const isDarkBg = backgroundColor ? (0, color_1.default)(backgroundColor).isDark() : false;
    ...
    return ((0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('content-block-cards', styleClass, layout === 'masonry' && 'layout-masonry', present(cardSize) && 'has-size', cardColumns && 'has-columns', present(cardMinSize) && 'has-min-size', present(accentSize) && 'has-accent-size', isDarkBg && 'dark-card-background'), style: {
            '--card-size': cardSize,
...
function CardBlock({ data }) {
    ...
    const accentColor = (_b = (0, utils_js_1.findByType)(data.config, 'accent_color')) === null || _b === void 0 ? void 0 : _b.value;
    const dividerColor = (_c = (0, utils_js_1.findByType)(data.config, 'divider_color')) === null || _c === void 0 ? void 0 : _c.value;
