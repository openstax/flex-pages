...
function CardsBlock({ data }) {
    ...
    const accentColorsRaw = (_d = (0, utils_js_1.findByType)(data.value.config, 'accent_colors')) === null || _d === void 0 ? void 0 : _d.value;
    const accentColors = accentColorsRaw
        ? accentColorsRaw.split(',').map((c) => c.trim()).filter(Boolean)
        : undefined;
    const dividerColorsRaw = (_e = (0, utils_js_1.findByType)(data.value.config, 'divider_colors')) === null || _e === void 0 ? void 0 : _e.value;
