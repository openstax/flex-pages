...
function TabbedContentBlock({ data, tabs: resolvedTabs }) {
    ...
    const alignment = (_b = (0, utils_js_1.findByType)(data.value.config, 'tab_alignment')) === null || _b === void 0 ? void 0 : _b.value;
    const activeColor = (_c = (0, utils_js_1.findByType)(data.value.config, 'active_color')) === null || _c === void 0 ? void 0 : _c.value;
    ...
    const analytics = (_g = (0, utils_js_1.findByType)(data.value.config, 'analytics_label')) === null || _g === void 0 ? void 0 : _g.value;
    const borderWidth = (_h = (0, utils_js_1.findByType)(data.value.config, 'border_width')) === null || _h === void 0 ? void 0 : _h.value;
    const bg = (0, utils_js_1.resolveBackground)(backgroundColor, gradientColor, gradientDirection);
    const defaultTabRaw = (_j = (0, utils_js_1.findByType)(data.value.config, 'default_tab')) === null || _j === void 0 ? void 0 : _j.value;
