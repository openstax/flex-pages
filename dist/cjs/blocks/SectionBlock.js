...
function SectionBlock({ data }) {
    ...
    const display = data.value.content.some(d => { var _a; return (_a = d.value.config) === null || _a === void 0 ? void 0 : _a.some(c => c.name === 'flex'); })
        ? 'flex' : 'block';
    return (0, jsx_runtime_1.jsx)("section", { id: id, className: (0, classnames_1.default)('content-block-section', { 'dark-background': isDark, [`content-block-${flex}`]: flex }), "data-analytics-nav": analytics, style: { backgroundColor,
        ...
        }, children: (0, jsx_runtime_1.jsx)("div", { className: "section-content", style: { textAlign, display, flexDirection: 'column' }, children: (0, jsx_runtime_1.jsx)(ContentBlocks_1.ContentBlocks, { data: data.value.content }) }) });
}
