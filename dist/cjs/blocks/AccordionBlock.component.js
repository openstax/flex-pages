...
function AccordionBlock({ data }) {
    ...
    const topBorderColor = (_d = (0, utils_js_1.findByType)(data.value.config, 'top_border_color')) === null || _d === void 0 ? void 0 : _d.value;
    ...
    return (0, jsx_runtime_1.jsx)("div", { className: (0, classnames_1.default)('content-block-accordion', { 'has-top-border': !!topBorderColor }), style: topBorderColor ? { '--accordion-top-border-color': topBorderColor } : undefined, children: items.map((item, i) => {
            ...
            const itemAccentColor = (_a = (0, utils_js_1.findByType)(item.config, 'accent_color')) === null || _a === void 0 ? void 0 : _a.value;
