...
exports.config = {
    ...
    categories: ['content'],
    label: 'People',
    description: 'A grid of person cards (name, title, photo, short bio, links, tags). A person with a full bio gets a clickable card that opens an expanded modal. Reuses the cards grid layout/config.',
    fields: [
