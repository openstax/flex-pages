...
function validateChildBlock(block, allowedCategories, path, ctx) {
    ...
    const blockCategories = (_a = def.config.categories) !== null && _a !== void 0 ? _a : [];
...
function validateBlockNode(block, def, path, ctx) {
    ...
    validateFieldSet((0, blockFields_js_1.fieldDefs)(def), block.value, path, ctx, loc);
}
/*
 ...
 */
function validateBlock(root, definitions) {
    var _a, _b;
