...
const LinkTargetFields = () => {
    var _a, _b;
    const actions = react_1.default.useContext(ContentBlockRoot_1.ActionContext);
    const routes = react_1.default.useContext(ContentBlockRoot_1.RouteContext);
    ...
    return (0, jsx_runtime_1.jsxs)(jsx_runtime_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(EditorFields_1.EditorField, { required: true, name: "type", label: "Link Type", type: "select", options: [
                ...
                (0, jsx_runtime_1.jsx)(EditorFields_1.EditorFields, { fields: actionFields })
                : null, type === 'route' ?
                ...
                (0, jsx_runtime_1.jsx)(EditorFields_1.EditorFields, { fields: routeFields })
                : null] });
};
