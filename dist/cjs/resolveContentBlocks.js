...
function resolveContentBlock(block, blocks) {
    ...
    const Comp = Block;
    return (0, jsx_runtime_1.jsx)(Comp, { data: block, ...slotProps }, block.id);
}
function resolveContentBlocks(data, blocks) {
    return (0, jsx_runtime_1.jsx)(jsx_runtime_1.Fragment, { children: data.map((block) => resolveContentBlock(block, blocks)) });
}
