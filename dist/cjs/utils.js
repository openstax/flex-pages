...
function resolveBackground(backgroundColor, gradientColor, gradientDirection) {
    ...
    if (gradientColor) {
        ...
        const mixed = (0, color_1.default)(backgroundColor).mix((0, color_1.default)(gradientColor), 0.5);
        return { background, backgroundColor, isDark: mixed.isDark() };
    }
    return { backgroundColor, isDark: (0, color_1.default)(backgroundColor).isDark() };
}
