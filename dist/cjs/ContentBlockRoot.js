...
const ContentBlockRootHoc = (ContentComponent) => ({ data, actions, routes, blocks }) => {
    return (0, jsx_runtime_1.jsx)(ContentBlockContext_1.BlockContext.Provider, { value: blocks, children: (0, jsx_runtime_1.jsx)(ActionContext_1.ActionContext.Provider, { value: actions !== null && actions !== void 0 ? actions : {}, children: (0, jsx_runtime_1.jsx)(RouteContext_1.RouteContext.Provider, { value: routes !== null && routes !== void 0 ? routes : {}, children: (0, jsx_runtime_1.jsx)(ContentComponent, { data: data }) }) }) });
};
