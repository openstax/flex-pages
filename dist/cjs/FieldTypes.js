...
const blocks = ({ name, label, categories }) => {
    const Forms = (0, FormsContext_1.useForms)();
    const inner = (0, jsx_runtime_1.jsxs)(Forms.List, { name: name, children: [(0, jsx_runtime_1.jsx)(Forms.ListItems, { children: (0, jsx_runtime_1.jsx)(DisplayBlockForm, { children: (0, jsx_runtime_1.jsx)(Forms.ListRecordRemoveButton, { children: "remove block" }) }) }), (0, jsx_runtime_1.jsx)(AddBlock, { categories: categories })] });
