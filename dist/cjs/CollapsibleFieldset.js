...
require("./CollapsibleFieldset.css");
const CollapsibleFieldset = ({ children, ...props }) => {
    const [collapsed, setCollapsed] = react_1.default.useState(false);
    return (0, jsx_runtime_1.jsxs)("fieldset", { className: (0, classnames_1.default)('collapsible-fieldset', { collapsed }), children: [(0, jsx_runtime_1.jsxs)("legend", { children: [(0, jsx_runtime_1.jsx)("button", { type: "button", onClick: () => setCollapsed(previous => !previous), children: collapsed ? unFoldIcon : foldIcon }), props.legend] }), children] });
};
