...
const FancySelect = (Forms) => ({ label, help, ...props }) => {
    ...
    return (0, jsx_runtime_1.jsxs)(Forms.FormInputWrapper, { children: [(0, jsx_runtime_1.jsxs)(Forms.FormLabelText, { children: [(0, jsx_runtime_1.jsx)(Forms.RequiredIndicator, { show: props.required }), label, ":"] }), (0, jsx_runtime_1.jsx)(react_select_1.default, { ...props, value: selected, onChange: onChange, 
                ...
                menuPosition: "fixed", styles: { menu: base => ({ ...base, zIndex: 9999 }) } }), (0, jsx_runtime_1.jsx)(Forms.HelpText, { value: help })] });
};
