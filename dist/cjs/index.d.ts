...
export declare const FancySelect: (Forms: typeof UI.Forms.Controlled) => ({ label, help, ...props }: FancySelectProps) => React.JSX.Element;
export declare const selectExtensions: ({ Forms }: {
    Forms: typeof UI.Forms.Controlled;
}) => {
    select: ({ label, help, ...props }: FancySelectProps) => React.JSX.Element;
};
export {};
