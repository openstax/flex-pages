...
function Link({ link, ...props }) {
    var _a;
    return (0, jsx_runtime_1.jsx)(LinkComponent, { linkTarget: link.target, ariaLabel: (_a = link.ariaLabel) !== null && _a !== void 0 ? _a : link.aria_label, ...props, children: link.text });
}
