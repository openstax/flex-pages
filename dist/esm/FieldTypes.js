...
export const blocks = ({ name, label, categories }) => {
    const Forms = useForms();
    const inner = _jsxs(Forms.List, { name: name, children: [_jsx(Forms.ListItems, { children: _jsx(DisplayBlockForm, { children: _jsx(Forms.ListRecordRemoveButton, { children: "remove block" }) }) }), _jsx(AddBlock, { categories: categories })] });
