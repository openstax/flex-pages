...
export function HeroBlock({ data, content, activeConditions }) {
    ...
    const topBorderSize = (_q = findByType(data.value.config, 'top_border_size')) === null || _q === void 0 ? void 0 : _q.value;
    const topBorderColor = (_r = findByType(data.value.config, 'top_border_color')) === null || _r === void 0 ? void 0 : _r.value;
    const bottomBorderSize = (_s = findByType(data.value.config, 'bottom_border_size')) === null || _s === void 0 ? void 0 : _s.value;
    const bottomBorderColor = (_t = findByType(data.value.config, 'bottom_border_color')) === null || _t === void 0 ? void 0 : _t.value;
    const analytics = (_u = findByType(data.value.config, 'analytics_label')) === null || _u === void 0 ? void 0 : _u.value;
    const bg = resolveBackground(backgroundColor, gradientColor, gradientDirection);
    const alignment = (_w = (_v = findByType(data.value.config, 'image_alignment')) === null || _v === void 0 ? void 0 : _v.value.toLowerCase()) !== null && _w !== void 0 ? _w : 'right';
