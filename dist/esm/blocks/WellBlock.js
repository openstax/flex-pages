...
export function WellBlock({ data }) {
    ...
    const textAlign = (_j = findByType(data.value.config, 'text_alignment')) === null || _j === void 0 ? void 0 : _j.value;
    const analytics = (_k = findByType(data.value.config, 'analytics_label')) === null || _k === void 0 ? void 0 : _k.value;
