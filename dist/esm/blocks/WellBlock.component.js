...
export function WellBlock({ data, content }) {
    ...
    const headingStyle = (_o = findByType(data.value.config, 'heading_style')) === null || _o === void 0 ? void 0 : _o.value;
    const pullUp = (_p = findByType(data.value.config, 'pull_up')) === null || _p === void 0 ? void 0 : _p.value;
    const borderColor = (_q = findByType(data.value.config, 'border_color')) === null || _q === void 0 ? void 0 : _q.value;
    const borderSize = (_r = findByType(data.value.config, 'border_size')) === null || _r === void 0 ? void 0 : _r.value;
    const analytics = (_s = findByType(data.value.config, 'analytics_label')) === null || _s === void 0 ? void 0 : _s.value;
