...
export function WellBlock({ data, content }) {
    ...
    const layout = (_o = findByType(data.value.config, 'layout')) === null || _o === void 0 ? void 0 : _o.value;
    const headingStyle = (_p = findByType(data.value.config, 'heading_style')) === null || _p === void 0 ? void 0 : _p.value;
    const pullUp = (_q = findByType(data.value.config, 'pull_up')) === null || _q === void 0 ? void 0 : _q.value;
    const borderColor = (_r = findByType(data.value.config, 'border_color')) === null || _r === void 0 ? void 0 : _r.value;
    const borderSize = (_s = findByType(data.value.config, 'border_size')) === null || _s === void 0 ? void 0 : _s.value;
    const analytics = (_t = findByType(data.value.config, 'analytics_label')) === null || _t === void 0 ? void 0 : _t.value;
    ...
    return _jsx("div", { id: id, className: cn('content-block-well', { 'dark-background': bg.isDark, 'light-background': isLight }), "data-analytics-nav": analytics, style: {
        ...
        }, children: _jsx("div", { className: cn('well-content', 'flex-content-container', flexAlignClass(textAlign), {
