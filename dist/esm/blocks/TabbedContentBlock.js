...
export function TabbedContentBlock({ data, tabs: resolvedTabs }) {
    ...
    const defaultTabRaw = (_h = findByType(data.value.config, 'default_tab')) === null || _h === void 0 ? void 0 : _h.value;
    ...
    return _jsxs("div", { id: id, className: cn('content-block-tabbed-content', alignment && `tab-align-${alignment}`, { 'dark-background': bg.isDark }), "data-analytics-nav": analytics, style: {
