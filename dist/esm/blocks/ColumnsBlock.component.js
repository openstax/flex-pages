...
export function ColumnsBlock({ data, leftContent, rightContent }) {
    ...
    return _jsxs("section", { id: id, "data-cols": scope, className: cn('content-block-columns', { 'dark-background': bg.isDark, [`content-block-${flex}`]: flex }), "data-analytics-nav": analytics, style: { background: bg.background, backgroundColor: bg.backgroundColor,
        ...
        }, children: [_jsx("style", { dangerouslySetInnerHTML: { __html: stackCSS } }), _jsxs("div", { className: "columns-content", children: [_jsx("div", { className: "content-block-columns-left flex-content-container", style: leftStyle, children: leftContent }), _jsx("div", { className: "content-block-columns-right flex-content-container", style: rightStyle, children: rightContent })] })] });
}
