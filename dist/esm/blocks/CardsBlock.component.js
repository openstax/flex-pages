...
export function CardsBlock({ data }) {
    ...
    const accentColors = toColorList((_e = findByType(data.value.config, 'accent_colors')) === null || _e === void 0 ? void 0 : _e.value);
    const dividerColors = toColorList((_f = findByType(data.value.config, 'divider_colors')) === null || _f === void 0 ? void 0 : _f.value);
    ...
    const borderSize = (_h = findByType(data.value.config, 'border_size')) === null || _h === void 0 ? void 0 : _h.value;
    const accentSize = (_j = findByType(data.value.config, 'accent_size')) === null || _j === void 0 ? void 0 : _j.value;
    const padding = (_k = findByType(data.value.config, 'padding')) === null || _k === void 0 ? void 0 : _k.value;
    const paddingTop = (_l = findByType(data.value.config, 'padding_top')) === null || _l === void 0 ? void 0 : _l.value;
    const paddingBottom = (_m = findByType(data.value.config, 'padding_bottom')) === null || _m === void 0 ? void 0 : _m.value;
    return (_jsx("div", { className: cn('content-block-cards', styleClass, present(cardSize) && 'has-size', cardColumns && 'has-columns', present(cardMinSize) && 'has-min-size', present(accentSize) && 'has-accent-size', accentColors && 'has-custom-accent', dividerColors && 'has-custom-divider', isDarkBg && 'dark-card-background'), style: {
            '--card-size': cardSize,
