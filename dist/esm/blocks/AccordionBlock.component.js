...
export function AccordionBlock({ data }) {
    ...
    const topBorderColor = (_d = findByType(data.value.config, 'top_border_color')) === null || _d === void 0 ? void 0 : _d.value;
    ...
    return _jsx("div", { className: cn('content-block-accordion', { 'has-top-border': !!topBorderColor }), style: topBorderColor ? { '--accordion-top-border-color': topBorderColor } : undefined, children: items.map((item, i) => {
            ...
            const itemAccentColor = (_a = findByType(item.config, 'accent_color')) === null || _a === void 0 ? void 0 : _a.value;
