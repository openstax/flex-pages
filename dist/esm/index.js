...
export const RichTextInput = (Forms) => ({ name, label, required, help }) => {
    ...
    return _jsxs(Forms.FormInputWrapper, { style: { userSelect: 'auto' }, children: [_jsxs(Forms.FormLabelText, { children: [_jsx(Forms.RequiredIndicator, { show: required }), label, ":"] }), _jsx(RichEditor, { defaultValue: value, onChange: setValue }), _jsx(Forms.HelpText, { value: help })] });
};
